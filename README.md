...
- Task 2 – Employee Table Design - Create the employees table and link each employee to a branch using a foreign key to enforce referential integrity.
...
- Task 4 – Audit-Safe Member ID Handling - Maintain intentional gaps in member IDs to simulate churn and ensure non-reusable identifiers for audit safety.
- Task 5 – Book Inventory Table Design - Create the books table using ISBN as a globally unique identifier and store metadata such as category, author, and rental price.
